  ...
  return (
    <MainLayout>
      <div className="my-[var(--space-40-90)]">
        ...
        >
          <Typography tag="span" text="Policy" className="highlight" />
        </Typography>
      </div>
      <div className="max-w-[90.65vw] lg:max-w-[62.5vw] mx-auto pb-[var(--space-120-180)]">
        <div className="flex flex-col gap-[var(--space-10-15)] mb-[var(--space-40-60)]">
          <Typography
            tag="p"
        ...
        <div className="flex flex-col gap-[var(--space-15-25)] mb-[var(--space-40-60)]">
          ...
          <div className="flex flex-col gap-[var(--space-10-15)]">
            ...
            <ul className="list-disc flex flex-col gap-0.5 ml-6 marker:text-[10px] marker:text-gray-700">
              <li>
                Fulfilling orders and personalizing your pet&apos;s meal plan
              </li>
              <li>
