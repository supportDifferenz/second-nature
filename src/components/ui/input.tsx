...
const variants = {
  ...
  roundedEdgeInputLg: "w-full h-13 sm:h-15  rounded-full border border-[#A1A1A1] outline-none bg-white px-4 py-2 text-base",
  dottedInput: "w-full h-13 rounded-full border-2 border-dashed border-[#C98A50] outline-none bg-[#F1F5DB] px-4 py-2 text-base",
};
