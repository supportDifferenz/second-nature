...
import MealTransition from "@/components/organism/MealTransition";
import PetFoodLooking from "@/components/organism/PetFoodLooking";
...
const mealContent = {
  beef: {
    ...
    healthBenefits: {
      paragraph: "A protein-packed beef meal rich in iron, omega-3s, and essential nutrients to support strong muscles, healthy digestion, and a vibrant coat.",
      benefits: [
        {
          icon: "/icons/heart-hand.svg",
          title: "Heart Health",
          description: "Packed with CoQ10, supporting cardiovascular function and cellular energy."
        },
        {
          icon: "/icons/eye-plus.svg",
          title: "Eye Health Booster",
          description: "Contains zinc and vitamin A to promote eye health and maintain clear vision."
        },
        {
          icon: "/icons/carrot.svg",
          title: "Muscle Strength",
          description: "High-quality protein aids in muscle development and maintenance."
        },
        {
          icon: "/icons/brain-03.svg",
          title: "Cognitive Function",
          description: "Rich in B-vitamins to support brain health and mental sharpness."
        }
      ]
    }
  },
  chicken: {
    ...
    healthBenefits: {
      paragraph: "A nutrient-dense chicken meal packed with proteins, vitamins, and minerals to boost immunity, support joint health, and promote overall wellness.",
      benefits: [
        {
          icon: "/icons/heart-hand.svg",
          title: "Balanced Protein & Fats",
          description: "White and dark chicken meat provides amino acids and healthy fats for sustained energy."
        },
        {
          icon: "/icons/eye-plus.svg",
          title: "Gut-Friendly Nutrition",
          description: "Butternut squash and cauliflower offer fiber and prebiotics for smooth digestion and gut health."
        },
        {
          icon: "/icons/carrot.svg",
          title: "Shiny Coat & Strong Joints",
          description: "Omega-3s from cod liver oil and egg yolk nourish the skin, coat, and joints."
        },
        {
          icon: "/icons/brain-03.svg",
          title: "Natural Detox & Immunity",
          description: "Kelp and nutritional yeast deliver trace minerals and antioxidants to support immune function and metabolism."
        }
      ]
    }
  },
  lamb: {
    ...
    healthBenefits: {
      paragraph: "A nutrient-dense recipe ideal for sensitive dogs, promoting joint health, immune function, and balanced metabolism with anti-inflammatory and thyroid-supporting ingredients.",
      benefits: [
        {
          icon: "/icons/heart-hand.svg",
          title: "Joint Support",
          description: "Lamb, a natural source of conjugated linoleic acid, reduces supports healthy joints  for active or aging dogs."
        },
        {
          icon: "/icons/eye-plus.svg",
          title: "Sensitive Stomachs",
          description: "Less likely to trigger allergies or sensitivities, lamb is perfect for dogs with dietary restrictions."
        },
        {
          icon: "/icons/carrot.svg",
          title: "Immune-Boosting",
          description: "Sweet potatoes and broccoli deliver high levels of antioxidants, vitamins C and E, and beta-carotene."
        },
        {
          icon: "/icons/brain-03.svg",
          title: "Thyroid and Metabolic Health",
          description: "Iodine rich kelp supports thyroid function, helping to regulate metabolism."
        }
      ]
    }
  }
