...
const bannerBaseClass = cn(
  "relative flex  justify-center text-center items-center w-full min-h-[640px] h-[90dvh] sm:min-h-[400px] sm:h-[d50vh] lg:min-h-[520px] sm:h-[70dvh] lg:max-h-[1200px] bg-cover bg-center transition-all"
);
