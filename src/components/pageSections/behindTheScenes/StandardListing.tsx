...
export default function StandardListing({image, title, description}: StandardListingProps) {
  return (
    <div className='flex flex-col items-center w-[var(--space-310-400)] gap-5 sm:gap-7'>
        <div className='flex flex-col w-fit items-center border-b border-primary'>
          ...
          />
            ...
            <Typography tag="h6" text={title} className="uppercase whitespace-nowrap px-2.5 sm:px-5 py-2.5"/>
        </div>
