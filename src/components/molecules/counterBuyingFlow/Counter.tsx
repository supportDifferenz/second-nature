    ...
    >
      <div className={`${className2} flex items-center gap-4`}>
        ...
        <input
          ...
          min={min}
          max={max}
          className={`${colorClass} ${className3} w-12 lg:w-14 text-center font-bold  text-primary-dark  placeholder-[#7C7C7C] placeholder:font-medium focus:placeholder-slate-300 bg-transparent border-none input-no-spinner focus:outline-none focus:ring-0`}
        />
