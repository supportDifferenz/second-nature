...
interface PetBowlSizeCardProps {
  imageSrc: string;
  altText?: string;
  label: string;
  selectedBowlSize: boolean;
  setSelectedBowlSize: () => void;
}

export default function PetBowlSizeCard({ imageSrc, altText = "petSelectCard", label, selectedBowlSize, setSelectedBowlSize }: PetBowlSizeCardProps) {
  return (
    <div 
      ...
      ${selectedBowlSize ? "border-secondary-1 border-[1.5px]" : "border-[#E8E8E8]"}`}
      onClick={setSelectedBowlSize}
    >
